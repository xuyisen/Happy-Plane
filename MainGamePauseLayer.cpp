...
bool MainGamePauseLayer::init() {
	...
	itemContinueMenu->setAnchorPoint(Point(0.5, 0));
	itemContinueMenu->setPosition(layerOut->getContentSize().width*0.3, 360);
	...
	itemMainGameMenu->setPosition(visibleSize.width*0.7, 360);
	itemMainGameMenu->setTag(2);

	auto menu = Menu::create(itemContinueMenu, itemRestartMenu, itemMainGameMenu, nullptr);
